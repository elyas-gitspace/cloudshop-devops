...
__⚠️ Note Importante sur l'Automatisation__
GitHub Actions est utilisé uniquement pour les tests et la validation, tandis que le déploiement se fait manuellement sur Minikube localement. Cette approche est choisie pour :
...
### **Workflow Global**
__Vue d'ensemble du processus__
...
bash
# Méthode 1 : Directement dans Minikube
minikube image build -t frontend:latest ./frontend
minikube image build -t product-api:latest ./product-api
minikube image build -t order-api:latest ./order-api

# Méthode 2 : Via Docker de Minikube
minikube docker-env
...
# Tester : curl http://localhost:5001/products
